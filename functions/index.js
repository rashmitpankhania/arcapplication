...
exports.sendMail = functions.https.onRequest((request, response) => {
  cors(request, response, () => {
    ...
    if (total) {
      if (category) {
        mailToOptions = {
          from: 'Arc Development', to: 'rashmitpankhania@gmail.com', subject: 'Estimate Received',
          html: `
    ...
    `
      ...
      mailToOptions = {
        from: 'Arc Development', to: email, subject: 'We got your message!',
        html: `
...
>
  ...
  <body align="center" style="margin:0; padding:0; background:#e5e5e5;">
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <tr>
                                        ...
                                        >
                                          Thanks for giving your estimate.We'll back to you as soon as possible.
                                        </td>
                                      </tr>
                                    </table>
                                  </td>
                                ...
                                <td align="center" style="padding:40px 10px">
                                  ...
                                  >
                                    ...
                                    <tr>
                                      ...
                                      >
                                        <a
                                          href="mailto:rashmitpankhania@gmail.com"
                                          style="color:#ffffff; text-decoration:none!important"
                                          >rashmitpankhania@gmail.com</a
                                        >
                                      </td>
                                    </tr>
                                  </table>
    ...
    `
      ...
      let mailToOptions = {
        from: 'Arc Development', to: 'rashmitpankhania@gmail.com', subject: 'Message Received',
        html: `
    <p style="font-size: 16px">Name:${name}</p>
    <p style="font-size: 16px">Email:${email}</p>
    <p style="font-size: 16px">Phone:${phone}</p>
