...
exports.sendMail = functions.https.onRequest((request, response) => {
  cors(request, response, () => {
    ...
    let mailToOptions = {from: 'Arc Development', to: 'rashmitpankhania@gmail.com', subject: 'Message Received',
    html: `
    ...
    mailToOptions = {from: 'Arc Development', to: email, subject: 'We got your message!',
      html: `
